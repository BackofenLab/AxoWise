...
export const store = createStore({
  ...
  mutations:{
    ...
    remove_snapshotPathway(state, value) {
      state.snapshot_pathways = state.snapshot_pathways.filter(dictionary => dictionary.id != value);
    },
    remove_snapshotHeatmap(state, value) {
      state.snapshot_heatmaps = state.snapshot_heatmaps.filter(dictionary => dictionary.id != value);
    },
