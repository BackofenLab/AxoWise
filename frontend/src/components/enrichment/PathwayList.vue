<template>
  <div id="pathways-list">
    <div class="tool-section-term">
      ...
      <div class="function-section">
        <div
          id="function-filter"
          class="pre-full"
          @mouseover="functions_active = true"
          @mouseleave="functions_active = false"
          :class="{ full: category_filtering == true }"
        >
          <img class="bookmark-image" src="@/assets/toolbar/menu-burger.png" />
        </div>
        <div
          id="function-filter-categories"
          v-show="functions_active == true"
          @mouseover="functions_active = true"
          @mouseleave="functions_active = false"
        >
          <div
          ...
          >
            <img
              ...
              src="@/assets/pathwaybar/favorite.png"
    ...
    <div class="list-section">
      ...
      <div
        class="results"
        v-if="terms !== null && await_load == false"
        tabindex="0"
                ...
                <div class="favourite-symbol">
                  <label class="custom-checkbox">
                    <div
                      ...
                      v-on:click.stop="add_enrichment(entry)"
                      :class="{ checked: favourite_tab.has(entry) }"
                      ref="checkboxStates"
                    ></div>
                  </label>
                </div>
...
.recolor_filter {
  filter: invert(71%) sepia(19%) saturate(7427%) hue-rotate(360deg)
