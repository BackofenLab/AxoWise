...
if __name__ == '__main__':
    ...
    source_dir = parent_dir + '/original_data/string_data/'
    # define the path to the target diretory
    target_dir = parent_dir + '/edited_data/'
    # define filename for the final csvs
    target_name1 = os.path.join(target_dir, 'rel_string_proteins_to_proteins.csv')
    ...
    path_to_proteins = os.path.join(source_dir, files[0])
    path_to_protein_rel = os.path.join(source_dir, files[1])
    path_to_funtional_term_edges = os.path.join(source_dir, files[2])
    # read csvs
