...
def run_queries():
    ...
    get_or_by_da_under_contexts(contexts=["12h-0h", "24h-0h"], subset=or_subset, positive=True, threshold=0.5, driver=driver)
    ...
    get_tg_by_de_under_contexts(contexts=["6h-0h", "24h-0h"], subset=gene_subset, positive=True, threshold=0.5, driver=driver)
