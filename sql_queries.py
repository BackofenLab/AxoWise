...
def get_pathways(cursor, species_id = 10090, protein1 = None, protein2 = None):
    ...
    query = """
        SELECT sets_items1.item_id, sets_items2.item_id, sets_items1.preferred_name, sets_items2.preferred_name, actions_sets.mode, sets.set_id, sets.title, sets.comment
